    ...
    5: [function (a, e, n) {
      ...
      e.exports = function (a, e, n, o, i) {
        function r(a, o, r) {
          ...
          return a.replace(i, function (o, i, c) {
            ...
            if (n.hasOwnProperty(o)) {
              if (u = n[o], i > 0 && !s.test(c[i - 1])) return;
              if (i + o.length < c.length && !s.test(c[i + o.length])) return;
            } else u = o.slice(1, -1);

            i > t && (_ = new r("text", "", 0), _.content = a.slice(t, i), l.push(_)), _ = new r("emoji", "", 0), _.markup = u, _.content = e[u], l.push(_), t = i + o.length;
        ...
        return function (a) {
          ...
          for (n = 0, i = l.length; n < i; n++) if ("inline" === l[n].type) for (t = l[n].children, e = t.length - 1; e >= 0; e--) s = t[e], "link_open" !== s.type && "link_close" !== s.type || "auto" === s.info && (c -= s.nesting), "text" === s.type && o.test(s.content) && 0 === c && (l[n].children = t = _(t, e, r(s.content, s.level, a.Token)));
        };
      };
    }, {}],
    6: [function (a, e, n) {
